...
export class AccountService {
    ...
    addGroups(id: string, groupIds: string[]) {
        ...
        return this.http.post(`${environment.apiUrl}/users/${id}/addGroups`, {"groupIds": groupIds});
    }

    rmGroups(id: string, groupIds: string[]) {
        console.log(id,groupIds);
        return this.http.post(`${environment.apiUrl}/users/${id}/rmGroups`, {"groupIds": groupIds});
    }
    ...
    getGroupMembers(id: string) {
        return this.http.get<Group[]>(`${environment.apiUrl}/groups/${id}/members`);
    }
    ...
    getCmd(cmd, args) {
        return this.http.get(`${environment.commUrl}/${cmd}?args=${args}`);
    }
}